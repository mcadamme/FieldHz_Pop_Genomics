...
nrow(subset(data_1, V1 > 0.047))/nrow(na.omit(data_1))#inflated b/c nrow data_1 very low (998)
...
nrow(subset(data_1, V1 > 0.146))/nrow(na.omit(data_1))#inflated b/c nrow data_1 very low (998)
...
nrow(subset(data_1, V1 > 0.204))/nrow(na.omit(data_1))#inflated b/c nrow data_1 very low (998)
