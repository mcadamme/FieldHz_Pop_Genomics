...
#subsetting data to include scaffolds within and outside of 3Mb region
...
LD_2002_not3Mb$distancekb <- with(LD_2002_not3Mb, LD_2002_not3Mb$BP_B-LD_2002_not3Mb$BP_A)/1000 ## the distance between snp1 and snp2 in kb
...
LD_2002_not3Mb$grp <- cut(LD_2002_not3Mb$distancekb, 0:40) ## bin 40kb
...
plot(r2means2002_not3Mb, ylab = "Mean R-squared", xlab = "Distance between SNPs (Kb)", ylim = c(0.05,0.20), col = "black", pch = 16)
lines(r2means2002_in3Mb, type = "p", col = "green", pch = 16)
lines(r2means2017_in3Mb, type = "p", col = "red", pch = 17)
lines(r2means2017_not3Mb, type = "p", col = "blue", pch = 17)
