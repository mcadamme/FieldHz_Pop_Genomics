...
~/src/FLASH-1.2.11-Linux-x86_64/flash index6_S4_L001_R1_001.fastq.gz index6_S4_L001_R2_001.fastq.gz --max-overlap=200 -o AMD_lib1_idx6 >&1 | tee AMD_lib1_idx6_flash.log

mv AMD_lib1* ./FLASH_output_AMD_lib1
###Copying all Flash output folders to new directory for demultiplexing.
