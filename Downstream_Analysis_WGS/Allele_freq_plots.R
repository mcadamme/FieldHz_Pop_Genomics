...
freqs_2017_Cry1 <- merge(sub_freqs_2017_spl, uniq_Cry1_scafs, by.x = "V1", by.y = "scaf")
...
all(All_Cry1$Allele1.2002 == All_Cry1$Allele1.2017)
...
for (i in 1:nrow(All_Cry1)){
  if (All_Cry1[i,5] - All_Cry1[i,10] - All_Cry1[i,15] < 0) {
    scaf <- c(All_Cry1[i,1], All_Cry1[i,1], All_Cry1[i,1])
    row <- c(i,i,i)
    dat <- c(All_Cry1[i,5], All_Cry1[i,10], All_Cry1[i,15])
    ...
    scaf <- c(All_Cry1[i,1], All_Cry1[i,1], All_Cry1[i,1])
    row <- c(i,i,i)
    dat <- c(All_Cry1[i,7], All_Cry1[i,12], All_Cry1[i,17])
    year <- c("2002", "2012")
    freq_change <- data.frame(cbind(scaf,row, dat, year))
    dat_for_Plot <- rbind(dat_for_Plot, freq_change)}
}
...
merged <- rbind(sub_freqs_2002_spl, sub_freqs_2012_spl)#long format
#merged <- rbind(sub_freqs_2002_spl, sub_freqs_2012_spl, sub_freqs_2017_spl)#long format
