...
LD_2002_Cry1Chr1 <- subset(LD_2002, CHR_A == "KZ118241.1")
...
LD_2002_Cry1Chr11 <- subset(LD_2002, CHR_A == "KZ118133.1")
...
LD_2002_notSel <- subset(LD_2002, CHR_A != "KZ118395.1" & CHR_A != "KZ118483.1" & 
                           ...
                           CHR_A != "KZ117975.1" & CHR_A != "KZ118067.1" & CHR_A != "KZ118133.1" &
                           CHR_A != "KZ117108.1" & CHR_A != "KZ118241.1")
head(LD_2002_notSel)
...
LD_2012_Cry1Chr1 <- subset(LD_2012, CHR_A == "KZ118241.1")
...
LD_2017_Cry1Chr1 <- subset(LD_2017, CHR_A == "KZ118241.1")
...
LD_2002_Cry1Chr1$distancekb <- with(LD_2002_Cry1Chr1, LD_2002_Cry1Chr1$BP_B-LD_2002_Cry1Chr1$BP_A)/1000
...
LD_2012_Cry1Chr1$distancekb <- with(LD_2012_Cry1Chr1, LD_2012_Cry1Chr1$BP_B-LD_2012_Cry1Chr1$BP_A)/1000
...
LD_2017_Cry1Chr1$distancekb <- with(LD_2017_Cry1Chr1, LD_2017_Cry1Chr1$BP_B-LD_2017_Cry1Chr1$BP_A)/1000
...
LD_2002_Cry1Chr1$grp <- cut(LD_2002_Cry1Chr1$distancekb, 0:10)
...
LD_2012_Cry1Chr1$grp <- cut(LD_2012_Cry1Chr1$distancekb, 0:10)
...
LD_2017_Cry1Chr1$grp <- cut(LD_2017_Cry1Chr1$distancekb, 0:10)
...
r2means2002_Cry1Chr1 <- with(LD_2002_Cry1Chr1, tapply(LD_2002_Cry1Chr1$R2, LD_2002_Cry1Chr1$grp, FUN = mean))
...
r2means2012_Cry1Chr1 <- with(LD_2012_Cry1Chr1, tapply(LD_2012_Cry1Chr1$R2, LD_2012_Cry1Chr1$grp, FUN = mean))
...
r2means2017_Cry1Chr1 <- with(LD_2017_Cry1Chr1, tapply(LD_2017_Cry1Chr1$R2, LD_2017_Cry1Chr1$grp, FUN = mean))
...
plot(r2means2002_notSel, ylab = "Mean R-squared", xlab = "Distance between SNPs (Kb)", ylim = c(0.08,0.4), col = "black", 
     type = "l", lty = 1, lwd = 3, cex.lab = 1.8, cex.axis = 1.5)
lines(r2means2002_in3Mb.1, type = "l", col = "red", lty = 1, lwd = 2)
lines(r2means2002_in3Mb.2, type = "l", col = "red", lty = 1, lwd = 2)
lines(r2means2002_Cry1Chr7.1, type = "l", col = "blue", lty = 1, lwd = 2)
lines(r2means2002_Cry1Chr7.2, type = "l", col = "blue", lty = 1, lwd = 2)
lines(r2means2002_Cry2Chr7, type = "l", col = "orange", lty = 1, lwd = 2)
lines(r2means2002_Cry1Chr1, type = "l", col = "blue", lty = 1, lwd = 2)
lines(r2means2002_Cry1Chr6, type = "l", col = "blue", lty = 1, lwd = 2)
lines(r2means2002_Cry1Chr11, type = "l", col = "blue", lty = 1, lwd = 2)
...
plot(r2means2012_notSel, ylab = "Mean R-squared", xlab = "Distance between SNPs (Kb)", ylim = c(0.08,0.4), col = "black", 
     type = "l", lty = 1, lwd = 3, cex.lab = 1.8, cex.axis = 1.5)
lines(r2means2012_in3Mb.1, type = "l", col = "red", lty = 1, lwd = 2)
lines(r2means2012_in3Mb.2, type = "l", col = "red", lty = 1, lwd = 2)
lines(r2means2012_Cry1Chr7.1, type = "l", col = "blue", lty = 1, lwd = 2)
lines(r2means2012_Cry1Chr7.2, type = "l", col = "blue", lty = 1, lwd = 2)
lines(r2means2012_Cry2Chr7, type = "l", col = "orange", lty = 1, lwd = 2)
lines(r2means2012_Cry1Chr1, type = "l", col = "blue", lty = 1, lwd = 2)
lines(r2means2012_Cry1Chr6, type = "l", col = "blue", lty = 1, lwd = 2)
lines(r2means2012_Cry1Chr11, type = "l", col = "blue", lty = 1, lwd = 2)
...
plot(r2means2017_notSel, ylab = "Mean R-squared", xlab = "Distance between SNPs (Kb)", ylim = c(0.08,0.4), col = "black", 
     type = "l", lty = 1, lwd = 3, cex.lab = 1.8, cex.axis = 1.5)
lines(r2means2017_in3Mb.1, type = "l", col = "red", lty = 1, lwd = 2)
lines(r2means2017_in3Mb.2, type = "l", col = "red", lty = 1, lwd = 2)
lines(r2means2017_Cry1Chr7.1, type = "l", col = "blue", lty = 1, lwd = 2)
lines(r2means2017_Cry1Chr7.2, type = "l", col = "blue", lty = 1, lwd = 2)
lines(r2means2017_Cry2Chr7, type = "l", col = "orange", lty = 1, lwd = 2)
lines(r2means2017_Cry1Chr1, type = "l", col = "blue", lty = 1, lwd = 2)
lines(r2means2017_Cry1Chr6, type = "l", col = "blue", lty = 1, lwd = 2)
lines(r2means2017_Cry1Chr11, type = "l", col = "blue", lty = 1, lwd = 2)
...
png(filename = "/media/megan/easystore/Fig4_Cry1Chr1_LD_decay.png", units = "px", height = 700, width = 800)
par(mar = c(5,6,4,2))
plot(r2means2002_notSel, ylab = "Mean R-squared", xlab = "Distance between SNPs (Kb)", ylim = c(0.08,0.4), col = "black", 
     type = "l", lty = 1, lwd = 2, cex.lab = 1.8, cex.axis = 1.5)
lines(r2means2002_Cry1Chr1, type = "l", col = "red", lty = 1, lwd = 2)

lines(r2means2012_Cry1Chr1, type = "l", col = "red", lty = 2, lwd = 2)
lines(r2means2012_notSel, type = "l", col = "black", lty = 2, lwd = 1.5)

lines(r2means2017_Cry1Chr1, type = "l", col = "red", lty = 3, lwd = 2)
lines(r2means2017_notSel, type = "l", col = "black", lty = 3, lwd = 1.5)
...
png(filename = "/media/megan/easystore/Fig4_Cry1Chr11_LD_decay.png", units = "px", height = 700, width = 800)
par(mar = c(5,6,4,2))
plot(r2means2002_notSel, ylab = "Mean R-squared", xlab = "Distance between SNPs (Kb)", ylim = c(0.08,0.26), col = "black", 
     type = "l", lty = 1, lwd = 2, cex.lab = 1.8, cex.axis = 1.5)
lines(r2means2002_Cry1Chr11, type = "l", col = "red", lty = 1, lwd = 2)

lines(r2means2012_Cry1Chr11, type = "l", col = "red", lty = 2, lwd = 2)
lines(r2means2012_notSel, type = "l", col = "black", lty = 2, lwd = 1.5)

lines(r2means2017_Cry1Chr11, type = "l", col = "red", lty = 3, lwd = 2)
lines(r2means2017_notSel, type = "l", col = "black", lty = 3, lwd = 1.5)
...
Cry1_KZ118241.1_2002 <- subset(LD_2002_Cry1Chr1, BP_A > (140000) & BP_A < (147000+1000))#plus1000bp to get full window
Cry1_KZ118241.1_2012 <- subset(LD_2012_Cry1Chr1, BP_A > (140000) & BP_A < (147000+1000))
Cry1_KZ118241.1_2017 <- subset(LD_2017_Cry1Chr1, BP_A > (140000) & BP_A < (147000+1000))
r2meansCry1_KZ118241.1_2002 <- with(Cry1_KZ118241.1_2002, tapply(Cry1_KZ118241.1_2002$R2, Cry1_KZ118241.1_2002$grp, FUN = mean))
r2meansCry1_KZ118241.1_2012 <- with(Cry1_KZ118241.1_2012, tapply(Cry1_KZ118241.1_2012$R2, Cry1_KZ118241.1_2012$grp, FUN = mean))
r2meansCry1_KZ118241.1_2017 <- with(Cry1_KZ118241.1_2017, tapply(Cry1_KZ118241.1_2017$R2, Cry1_KZ118241.1_2017$grp, FUN = mean))
